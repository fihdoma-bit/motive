...
export const CreateScreen: React.FC<CreateScreenProps> = ({ addMotive, currentUser, userBudget }) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const newMotive: Motive = {
            ...
            privacy,
            // FIX: Correctly initialize participants with the currentUser object.
            // The previous object literal was not a valid 'User' type because it used 'userId' instead of 'id' and was missing other properties.
            participants: [currentUser],
            createdBy: currentUser.id,
            image: `https://picsum.photos/seed/${title.replace(/\s/g, '')}/600/400`,
        };
        addMotive(newMotive);
