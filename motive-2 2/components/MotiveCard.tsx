...
export const MotiveCard: React.FC<MotiveCardProps> = ({ motive, onSelectMotive }) => {
  return (
    ...
    >
      <img src={motive.image_url} alt={motive.title} className="w-full h-40 object-cover" />
      <div className="p-4">
        ...
        <div className="mt-4 pt-4 border-t border-gray-100 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-2 text-gray-600">
             ...
             <span className="font-medium">{motive.participants.length} / {motive.max_participants}</span>
          </div>
        </div>
      </div>
    </div>
